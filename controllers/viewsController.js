...
exports.alerts = (req, res, next) => {
    ...
    if (alert === 'booking')
        res.locals.alert = "your booking was successfull! please check your email for a confirmation. if your booking doesn't show up here immediatly. please come back later.";
